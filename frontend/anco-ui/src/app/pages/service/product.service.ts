...
export class ProductService {
    ...
    constructor(private http: HttpClient) {
        this._productos = this.getProductsData();
    }
    ...
    getProductsMini() {
        return Promise.resolve(this._productos.slice(0, 5));
    }

    getProductsSmall() {
        return Promise.resolve(this._productos.slice(0, 10));
    }
    ...
    async update(id: string, product: Product): Promise<Product> {
        ...
        if (idx > -1) {
            ...
            return Promise.resolve(this._productos[idx]);
        }
