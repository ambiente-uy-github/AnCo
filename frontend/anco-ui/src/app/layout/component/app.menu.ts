        ...
        this.model = [
            {
                ...
                items: [
                    ...
                    { label: 'Contratos', icon: 'pi pi-fw pi-file', routerLink: ['/pages/contratos'] },
                    {
                        label: 'Empresas',
                        icon: 'pi pi-fw pi-building',
                        routerLink: ['/pages/empresas'],
                        items: [
                            {
                                label: 'Plantas',
                                icon: 'pi pi-fw pi-th-large',
                                routerLink: ['/pages/plantas'],
                                items: [
                                    { label: 'Emisores', icon: 'pi pi-fw pi-send', routerLink: ['/pages/emisores'] }
                                ]
                            }
                        ]
                    },
